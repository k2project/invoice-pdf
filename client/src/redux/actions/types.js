...
export const SET_PROFILE_CURRENT_NAV_LINK = 'SSET_PROFILE_CURRENT_NAV_LINK ';
//company
export const SET_COMPANY_CURRENT_NAV_LINK = 'SET_COMPANY_CURRENT_NAV_LINK';
export const GET_ALL_COMPANIES = 'GET_ALL_COMPANIES';
export const CLEAR_ALL_COMPANIES = 'CLEAR_ALL_COMPANIES';
export const COMPANY_DELETED = 'COMPANY_DELETED';
export const TASK_TO_UPDATE = 'TASK_TO_UPDATE';
